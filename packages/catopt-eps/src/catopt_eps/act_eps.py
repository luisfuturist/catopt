...
The ε machinery in :mod:`catopt_eps.eps` certifies *weight* substitutions —
...
(``catopt_core.ops.OpTable`` folds it in; no import-time mutation of
...
#  lowering fragment ``catopt_core.ops.OpTable`` folds into the table
...
#: (plan 0001 phase 2c): :class:`catopt_core.ops.OpTable` folds this dict in
...
def _has_var(t, _memo: dict | None = None) -> bool:
    ...
    Delegates to :func:`catopt_core.typing.has_var_leaf`, the single
