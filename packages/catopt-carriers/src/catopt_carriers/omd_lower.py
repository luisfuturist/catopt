...
After the cross-carrier lifts (:func:`catopt_carriers.xcarrier.omd_tree_lift`),
...
scan state.  The generic :class:`~catopt_torch.torch_bridge.IRModule`
...
:class:`~catopt_carriers.scan_lower.BatchedScanModule` analogue for the omd
carrier:
...
class BatchedOmdModule(BatchedExecutorBase, torch.nn.Module):
    ...
    param_values : dict[str, torch.Tensor] | None
        As for :func:`~catopt_torch.torch_bridge.ir_to_torch_module`.
